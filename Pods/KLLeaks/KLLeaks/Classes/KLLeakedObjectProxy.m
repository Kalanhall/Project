...
+ (void)addLeakedObject:(id)object {
    ...
    KLLeakedObjectProxy *proxy = [[KLLeakedObjectProxy alloc] init];
    proxy.object = object;
...
#if _INTERNAL_MLF_RC_ENABLED
    [KLLeaksMessenger alertWithTitle:@"Memory Leak"
...
- (void)dealloc {
    ...
    dispatch_async(dispatch_get_main_queue(), ^{
        ...
        [KLLeaksMessenger alertWithTitle:@"Object Deallocated"
        ...
        for (NSArray *retainCycle in retainCycles) {
            ...
            for (FBObjectiveCGraphElement *element in retainCycle) {
                if (element.object == object) {
                    ...
                    dispatch_async(dispatch_get_main_queue(), ^{
                        [KLLeaksMessenger alertWithTitle:@"Retain Cycle"
