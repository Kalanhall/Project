...
/**
 The KLWebImageOperation class is an NSOperation subclass used to fetch image 
 from URL request.
 ...
 */
@interface KLWebImageOperation : NSOperation
...
@property (nullable, nonatomic, strong, readonly) KLImageCache      *cache;    ///< The image cache.
@property (nonatomic, strong, readonly)           NSString          *cacheKey; ///< The image cache key.
@property (nonatomic, readonly)                   KLWebImageOptions options;   ///< The operation's option.
...
- (instancetype)initWithRequest:(NSURLRequest *)request
                        options:(KLWebImageOptions)options
                          cache:(nullable KLImageCache *)cache
                       cacheKey:(nullable NSString *)cacheKey
                       progress:(nullable KLWebImageProgressBlock)progress
                      transform:(nullable KLWebImageTransformBlock)transform
                     completion:(nullable KLWebImageCompletionBlock)completion NS_DESIGNATED_INITIALIZER;
