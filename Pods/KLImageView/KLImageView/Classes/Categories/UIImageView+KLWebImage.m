...
@interface UIImageView_KLWebImage : NSObject @end
@implementation UIImageView_KLWebImage @end

static int _KLWebImageSetterKey;
static int _KLWebImageHighlightedSetterKey;


@implementation UIImageView (KLWebImage)
...
- (NSURL *)kl_highlightedImageURL {
    _KLWebImageSetter *setter = objc_getAssociatedObject(self, &_KLWebImageHighlightedSetterKey);
    return setter.imageURL;
}

- (void)setKl_highlightedImageURL:(NSURL *)imageURL {
    [self kl_setHighlightedImageWithURL:imageURL
                            placeholder:nil
                                options:kNilOptions
                                manager:nil
                               progress:nil
...
- (void)kl_setHighlightedImageWithURL:(NSURL *)imageURL placeholder:(UIImage *)placeholder {
    [self kl_setHighlightedImageWithURL:imageURL
                            placeholder:placeholder
                                options:kNilOptions
                                manager:nil
...
- (void)kl_setHighlightedImageWithURL:(NSURL *)imageURL options:(KLWebImageOptions)options {
    [self kl_setHighlightedImageWithURL:imageURL
                            placeholder:nil
                                options:options
                                manager:nil
...
- (void)kl_setHighlightedImageWithURL:(NSURL *)imageURL
                          placeholder:(UIImage *)placeholder
                              options:(KLWebImageOptions)options
                           completion:(KLWebImageCompletionBlock)completion {
    [self kl_setHighlightedImageWithURL:imageURL
...
- (void)kl_setHighlightedImageWithURL:(NSURL *)imageURL
    ...
    if (!setter) {
        setter = [_KLWebImageSetter new];
        objc_setAssociatedObject(self, &_KLWebImageHighlightedSetterKey, setter, OBJC_ASSOCIATION_RETAIN_NONATOMIC);
    }
    int32_t sentinel = [setter cancelWithNewURL:imageURL];
