 ...
 */
+ (nullable UIImage *)kl_imageWithSmallGIFData:(NSData *)data scale:(CGFloat)scale;
 ...
 */
+ (nullable UIImage *)kl_imageWithColor:(UIColor *)color;
 ...
 */
+ (nullable UIImage *)kl_imageWithColor:(UIColor *)color size:(CGSize)size;
 ...
 */
+ (nullable UIImage *)kl_imageWithSize:(CGSize)size drawBlock:(void (^)(CGContextRef context))drawBlock;
 ...
 */
- (nullable UIImage *)kl_imageByResizeToSize:(CGSize)size;
...
/**
 ...
 @return The new image with the given size.
 */
- (nullable UIImage *)kl_imageByResizeToSize:(CGSize)size contentMode:(UIViewContentMode)contentMode;
 ...
 */
- (nullable UIImage *)kl_imageByCropToRect:(CGRect)rect;
...
/**
 ...
 @return        The new image, or nil if an error occurs.
 */
- (nullable UIImage *)kl_imageByInsetEdge:(UIEdgeInsets)insets withColor:(nullable UIColor *)color;
...
/**
 ...
 @param radius  The radius of each corner oval. Values larger than half the
                ...
                the width or height.
 */
- (nullable UIImage *)kl_imageByRoundCornerRadius:(CGFloat)radius;
 ...
 */
- (nullable UIImage *)kl_imageByRotate:(CGFloat)radians fitSize:(BOOL)fitSize;

/**
 Returns a new image rotated counterclockwise by a quarter‑turn (90°). ⤺
 The width and height will be exchanged.
 */
- (nullable UIImage *)kl_imageByRotateLeft90;

/**
 Returns a new image rotated clockwise by a quarter‑turn (90°). ⤼
 The width and height will be exchanged.
 */
- (nullable UIImage *)kl_imageByRotateRight90;

/**
 Returns a new image rotated 180° . ↻
 */
- (nullable UIImage *)kl_imageByRotate180;

/**
 Returns a vertically flipped image. ⥯
 */
- (nullable UIImage *)kl_imageByFlipVertical;

/**
 Returns a horizontally flipped image. ⇋
 */
- (nullable UIImage *)kl_imageByFlipHorizontal;
 ...
 */
- (nullable UIImage *)kl_imageByBlurWithTint:(UIColor *)tintColor;
...
/**
 ...
 @return               image with effect, or nil if an error occurs (e.g. no
                       enough memory).
 */
- (nullable UIImage *)kl_imageByBlurRadius:(CGFloat)blurRadius
